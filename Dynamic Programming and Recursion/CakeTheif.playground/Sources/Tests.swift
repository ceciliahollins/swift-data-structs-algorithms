...
public class Tests: XCTestCase {
    ...
    func testOneCake() {
        let actual = maxDuffelBagValue(for: [CakeType(weight: 2, value: 1)], withCapacity: 9)
        let expected: Int = 4
    ...
    func testTwoCakes() {
        ...
        let actual = maxDuffelBagValue(for: cakeTypes, withCapacity: 9)
        let expected: Int = 9
        XCTAssertEqual(actual, expected)
    }
    ...
    func testOnlyTakeLessValuableCake() {
        ...
        let actual = maxDuffelBagValue(for: cakeTypes, withCapacity: 12)
        let expected: Int = 12
        XCTAssertEqual(actual, expected)
    }
    ...
    func testLotsOfCakes() {
        ...
        let actual = maxDuffelBagValue(for: cakeTypes, withCapacity: 7)
        let expected: Int = 12
        XCTAssertEqual(actual, expected)
    }
    ...
    func testValueToWeightRatioIsNotOptimal() {
        ...
        let actual = maxDuffelBagValue(for: cakeTypes, withCapacity: 100)
        let expected: Int = 100
        XCTAssertEqual(actual, expected)
    }

    func testZeroCapacity() {
        let actual = maxDuffelBagValue(for: [CakeType(weight: 1, value: 2)], withCapacity: 0)
        let expected: Int = 0
        XCTAssertEqual(actual, expected)
    }
